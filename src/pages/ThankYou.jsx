    ...
    <>
      ...
      <section className="page-section">
        <div className="container simple-page">
          <h1>Thank You</h1>
          {accepted ? <p>Your message was submitted successfully. Naomi Gregory Salon, LLC will respond as soon as possible.</p> : <p>This confirmation page is shown only after the contact form is accepted. If you still need to send a message, please visit the Contact page.</p>}
